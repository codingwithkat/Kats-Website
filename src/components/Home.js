...
export const Home = () => (
    <div>
        ...
        <p>
            ...
            the Education Industry specifically focused on Business Operations in the Franchise world utilizing my communication skills.  Now, I am looking
            to make a change and join the ever growing <strong>Tech industry</strong>.  April 2020, I decided
            to
