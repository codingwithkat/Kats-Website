        ...
        <Row className="intro">
                ...
                <div className="intro">
                   ...
                   <p>
                    ...
                    the Education Industry specifically focused on Business Operations in the Franchise world utilizing my communication and project management skills. In April of 2020, I decided to take a course on HTML and the rest was history. I quickly made the decision to gain the necessary technical skills to transition into the tech industry as a developer/product manager!
                    </p>
                    <p>
