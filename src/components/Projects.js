          ...
          <Row>
              <Col md={6}>
                <div className="card" style={{ width: '30rem' }}>
                    ...
                    <div className="card-body">
                        <h5 className="card-title"><a href="http://comicsans-app.herokuapp.com/" className="proj-link">Comic Sans</a></h5>
              ...
              <Col md={6}>
                <div className="card" style={{ width: '30rem' }}>
                    ...
                    <div className="card-body">
                        <h5 className="card-title"><a href="https://artemis-workouts.herokuapp.com/home" className="proj-link">Artemis Workouts</a></h5>
          ...
          <Row>
              <Col md={6}>
                <div className="card" style={{ width: '30rem' }}>
                    ...
                    <div className="card-body">
                        <h5 className="card-title"><a href="https://gh-skincare1.herokuapp.com/" className="proj-link">E-commerce SkinCare</a></h5>
              ...
              <Col md={6}>
                <div className="card" style={{ width: '30rem' }}>
                    ...
                    <div className="card-body">
                        <h5 className="card-title"><a href="https://react-city-weather-app.netlify.app/" className="proj-link">React City Weather App</a></h5>
