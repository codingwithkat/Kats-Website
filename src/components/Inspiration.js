...
export const Inspiration = () => (
    <div>
        ...
        <Container className="container">
            ...
            <p className="inspo-3">
                That is why I decided to learn how to <strong>code</strong> and <strong>create web applications.</strong> I wanted to gain the necassary skills in order to better <strong>communicate with engineers, clients, stakeholders</strong> and other team members so I could take my previous experiences and combine them with my technical abilities. I can now sit in meetings and understand a variety of <strong>technologies</strong> and how they work, how they can better assist <strong>clients</strong> and how to make better <strong>products</strong> as a result!</p>
